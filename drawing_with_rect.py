...
text_rectangle = text_surface.get_rect(center = (400, 50)) # centering text
while True :
    ...
    pygame.draw.rect(screen, '#c0e8ec', text_rectangle, 10) #draw a rect surround the text and a margin i think
