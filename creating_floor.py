...
while True :
    ...
    for event in pygame.event.get() :
        ...
        if event.type == pygame.KEYDOWN :
            if event.key == pygame.K_SPACE :
                if player_rectangle.bottom >= 300 : # sao k phai = ma >=
                    player_gravity = -20
    ...
    if player_rectangle.bottom >= 300: player_rectangle.bottom = 300 # 300 la tinh tu topleft nhe ca nha, lon hon 300 se roi xuong duoi a
